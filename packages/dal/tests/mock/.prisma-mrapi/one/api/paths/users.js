    ...
    parameters: [
      {
        ...
        required: false,
        description:
          'Wraps all model fields in a type so that the list can be filtered by any property. Supported types "equals", "not", "in", "not_in", "lt", "lte", "gt", "gte", "contains", "not_contains", "starts_with", "not_starts_with", "ends_with", "not_ends_with". Example: id_in:1,2,3',
      },
      {
        name: 'orderBy',
        in: 'query',
